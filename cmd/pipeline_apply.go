...
func init() {
	...
	pipelineApplyCmd.Flags().StringArrayVar(&labels, "labels-only", []string{}, "Filter pipelines to apply by their labels, accepted as a comma separated list (key:value)")
